...
SOURCE_DIR="/var/DWS/bkp/AIR"
INCOMING_DIR="/var/DWS/incoming/CS40/AIR"
TARGET_DIR="/var/DWS/processing/CS40/AIR"
...
NO_OF_TARGET=`find $TARGET_DIR -type f -name *AIROUTPUTCDR* | wc -l`
...
for file in `find $SOURCE_DIR -type f -name CDRAIR* -print | tail -$NUM_OF_FILES_TO_MOVE`
do
