...
SOURCE_DIR="/var/DWS/bkp/CCN"
INCOMING_DIR="/var/DWS/incoming/CS40/CCN"
TARGET_DIR="/var/DWS/processing/CS40/CCN_USAGE"
...
NO_OF_TARGET=`find $TARGET_DIR -type f -name *CDRCCN* | wc -l`
...
for file in `find $SOURCE_DIR -type f -name CDRCCN* -print | tail -$NUM_OF_FILES_TO_MOVE`
do
